...
const ManageApplicationsScreen: React.FC<Props> = ({ navigation }) => {
  ...
  const handleViewProfile = (applicantId: string) => {
    // Since we don't have a direct route to view job seeker profiles in the employer stack,
    // we'll show an alert for now. In a real implementation, you would add this screen
    // to the navigation stack and navigate to it.
    Alert.alert(
      'View Profile',
      `Viewing profile for applicant ID: ${applicantId}`,
      [
